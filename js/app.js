    ...
    class ProjectAnimation {
        ...
        draw(triggerElement, svg, title, content,image) {
            ...
            new ScrollMagic.Scene({
                ...
                console.log(Math.round(scroll.progress * (this.shapes.length - 1)) , titleDrawn)
...
// new ScrollMagic.Scene({
//     triggerElement: ".snakeai-project",
//     triggerHook: 1,
//     duration: "80%",
//     offset: 50
// }).on("progress", (scroll) => {
//     anime({
//         targets: '.snakeai-svg',
//         d: shapes[Math.round(scroll.progress * (shapes.length - 1))],
//         easing: 'easeOutQuad',
//         duration: 2000,
//     });
// })
